            ...
            <div className="meta-programming-page__note">
              ...
              <div className="meta-programming-page__note-body">
                <div className="meta-programming-page__bullet">
                  - Proxy обгортка: cross-cutting concerns (логування/метрики) без
                  змін бізнес-логіки.
                </div>
                <div className="meta-programming-page__bullet">
                  - Memoize обгортка: функція вищого порядку, яка генерично змінює
                  runtime поведінку (кеш).
                </div>
                <div className="meta-programming-page__bullet">
                ...
                <div className="meta-programming-page__bullet">
                  - Типізований event emitter: type-safe pub/sub (метапрограмування
                  через generic обмеження).
                </div>
              </div>
            </div>
          </>
